      ...
      <div className="grid" style={{ gridTemplateColumns: "320px 1fr 320px", minHeight: "calc(100vh - 64px)" }}>
        ...
        <div className="border-l border-white/10 p-3 space-y-3">
          ...
          <div className="pt-2 border-t border-white/10 space-y-2">
            ...
            <div className="text-[11px] opacity-70">W trybie „edytuj węzły" możesz przeciągać węzły, Alt+klik (lub klik na płótnie) – wstaw nowy punkt, Delete – usuń zaznaczony punkt.</div>
          </div>
        </div>
      </div>
    </div>
